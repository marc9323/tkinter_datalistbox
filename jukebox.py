...
class DataListBox(Scrollbox):
    ...
    def requery(self, link_value=None):
        self.link_value = link_value  # stores the id, know the master record populated from
    ...
    def on_select(self, event):
        if self.linked_box:
            ...
            # 1. get id from db row
            # 2. confirm its correct by including link_value when needed
            if self.link_value:
